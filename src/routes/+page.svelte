...
<nav class="p-4 flex justify-between items-center bg-[#121481] text-2xl">
    ...
    <ul class="flex gap-8">
        ...
        <li>
            <a href="mailto:suchitg04@gmail.com">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-auto w-8 fill-[#FFEAE3] hover:transition-colors ease-in-out hover:fill-[#FD7776] hover:scale-105  duration-300">
